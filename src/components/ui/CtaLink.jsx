...
export function CtaLink({
  ...
  const base =
    'inline-flex items-center justify-center gap-2 font-sans text-xs uppercase tracking-[.2em] transition-opacity duration-300 cursor-pointer whitespace-nowrap';
